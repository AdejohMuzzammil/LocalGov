...
from LocalGov.models import *


class Command(BaseCommand):
    help = 'Populates the database with all 36 states and their local governments in Nigeria'

    def handle(self, *args, **kwargs):
        # List of all states and their local governments
        states_and_lgas = {
            ...
            'Adamawa': ['Demsa', 'Fufore', 'Ganye', 'Gayuk', 'Gombi', 'Grie', 'Hong', 'Jada', 'Lamurde',
            ...
            'Kaduna': ['Birnin Gwari', 'Chikun', 'Giwa', 'Igabi', 'Ikara', 'Jaba', 'Jema’a', 'Kachia',
                       ...
                       'Kudan', 'Lere', 'Makarfi', 'Sabon Gari', 'Sanga', 'Soba', 'Zangon Kataf',
                       'Zaria'],
            ...
            'Kano': ['Ajingi', 'Albasu', 'Bagwai', 'Bebeji', 'Bichi', 'Bunkure', 'Dala', 'Dambatta',
                     ...
                     'Gaya', 'Gezawa', 'Gwale', 'Gwarzo', 'Kabo', 'Kano Municipal', 'Karaye',
            ...
            'Ogun': ['Abeokuta North', 'Abeokuta South', 'Ado-Odo/Ota', 'Ewekoro', 'Ifo', 'Ijebu East',
                     'Ijebu North', 'Ijebu North East', 'Ijebu Ode', 'Ikenne', 'Imeko Afon',
                     'Ipokia', 'Obafemi Owode', 'Odeda', 'Odogbolu', 'Ogun Waterside', 'Remo North',
                     'Shagamu', 'Yewa North', 'Yewa South'],

            'Ondo': ['Akoko North-East', 'Akoko North-West', 'Akoko South-West', 'Akoko South-East',
            ...
            'Osun': ['Atakunmosa East', 'Atakunmosa West', 'Aiyedaade', 'Aiyedire', 'Boluwaduro',
                     'Boripe', 'Ede North', 'Ede South', 'Egbedore', 'Ejigbo', 'Ifedayo',
                     'Ifelodun', 'Ife Central', 'Ife East', 'Ife North', 'Ife South', 'Ila',
            ...
            'Taraba': ['Ardo Kola', 'Bali', 'Donga', 'Gashaka', 'Gassol', 'Ibi', 'Jalingo',
        ...
        for state_name, lgas in states_and_lgas.items():
            ...
            for lga_name in lgas:
                lga, created = LocalGovernment.objects.get_or_create(name=lga_name, state=state)
                if created:
                    self.stdout.write(self.style.SUCCESS(f'  - Created LGA: {lga_name}'))

        self.stdout.write(self.style.SUCCESS('Database successfully populated with states and LGAs.'))